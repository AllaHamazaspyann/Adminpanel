...
class Articles extends Component {
  ...
  render(){
    const { handleOrderChange, getSearchedArticle } = this.props;
    const { articlesState: {articles, order, search_value} } = this.props;

    console.log('articles', search_value);
    ...
    return (
      <>
        ...
        <S.Search placeholder='Search' onChange={(e) => handleChange(e)}/> <S.SearchButton onClick={getSearchedArticle}>Search</S.SearchButton>        
